...
if __name__ == "__main__":
    ...
    parser.add_argument('--subs_rate', type=str, default='1,1', help='range of percent CONVERSION for the labeling nucleotide', required=False)
    ...
    output_filename = str(args.o) + base_filename + "_monolabeled.tsv"
